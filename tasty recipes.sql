...
ALTER TABLE `favorite`
  ADD UNIQUE KEY `user_ID` (`user_ID`,`recipe_ID`,`cookbook_ID`);
...
--
ALTER TABLE `cookbook`
  MODIFY `cookbook_ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
